...
promData2 <- mutate(promData2,  deltaEQ5D = eq5d1de -eq5d0de,
                              deltaEQVAS = halsvas1 - halsvas0)
...
# 2. test for trends
 eq5d <- c(with(classC, ir(eq5d0de, eq5d1de, 0.9)), 
           with(classB, ir(eq5d0de, eq5d1de, 0.9)),
           with(classA, ir(eq5d0de, eq5d1de, 0.9)))

eq5dSDS <- c(with(classC, irSD(eq5d0de, eq5d1de, 0.9)), 
             with(classB, irSD(eq5d0de, eq5d1de, 0.9)),
             with(classA, irSD(eq5d0de, eq5d1de, 0.9)))
...
# 2. test for trends
 eqvas <- c(with(classA, ir(halsvas0, halsvas1, 82)), 
            with(classB, ir(halsvas0, halsvas1, 82)),
            with(classC, ir(halsvas0, halsvas1, 82)))

eqvasSDS <- c(with(classA, irSD(halsvas0, halsvas1, 82)), 
              with(classB, irSD(halsvas0, halsvas1, 82)),
              with(classC, irSD(halsvas0, halsvas1, 82)))
...
tiff(filename = "CharneyClassification2015-01-20x.tif",
     width = 20,  height = 12, units= 'cm', pointsize = 10,
...
plot.window(ylim=c(0, 4), xlim=c(0, 1))
         text(0,  1.5, 'EQ-5D Index', cex = 2.0, col = 'black', pos = 4)
         text(0,  3.5, 'EQ-VAS',      cex = 2.0, col = 'black', pos = 4)
...
plot.window(ylim=c(0, 4), xlim=c(0, 1))
         ...
         text(0,  1.0, 'Class B',   cex = 1.5, col = 'black', pos = 4)
         text(0,  0.5, 'Class C',   cex = 1.5, col = 'black', pos = 4)

         # EQ-VAS
         text(0,  3.5, 'Class A',   cex = 1.5, col = 'black', pos = 4)
         text(0,  3.0, 'Class B',   cex = 1.5, col = 'black', pos = 4)
...
plot.window(ylim=c(0, 4), xlim=c(0, 1))
         ...
         text(0,  1.0, '0.59',   cex = 1.5, col = 'black', pos = 4)
         text(0,  0.5, '0.53',   cex = 1.5, col = 'black', pos = 4)

         # EQ-VAS
         text(0,  3.5, '62.72',   cex = 1.5, col = 'black', pos = 4)
         text(0,  3.0, '59.62',   cex = 1.5, col = 'black', pos = 4)
...
plot.window(ylim=c(0, 4), xlim=c(0, 1))
         ...
         text(0,  1.0, '0.81',   cex = 1.5, col = 'black', pos = 4)
         text(0,  0.5, '0.78',   cex = 1.5, col = 'black', pos = 4)

         # EQ-VAS
         text(0,  3.5, '82.61',   cex = 1.5, col = 'black', pos = 4)
         text(0,  3.0, '77.05',   cex = 1.5, col = 'black', pos = 4)
...
axis(1, lwd=3, at=seq(50, 110, by = 10), cex.axis = 2.00, font = 2)
     ####### EQ-5D
     # A
     segments(x0 = 87.68800, y0 = 1.5,  x1 = 94.52889, y1 = 1.5, lwd = 2, col = 'black')
     points(91.10844, 1.5, pch = 15, cex =3, col = 'grey')
     # B
     segments(x0 = 64.10418, y0 = 1.0,  x1 = 78.30694, y1 = 1.0, lwd = 2, col = 'black')
     points(71.20556, 1.0, , pch = 15, cex =3, col = 'grey')
     # C
     segments(x0 = 62.38479, y0 = 0.5,  x1 = 69.92422, y1 = 0.5, lwd = 2, col = 'black')
     points(66.15450, 0.5, pch = 15, cex =3, col = 'grey')

text(x = 60, y = 0.10, expression(chi[1]^2 ==70))
text(x = 67, y = 0.10, paste(', p < 0.0001'))
text(x = 60, y = 0.22, paste('Trend test:'))     
     ...
     # B
     segments(x0 = 67.63961, y0 = 3.0,  x1 = 88.08589, y1 = 3.0, lwd = 2, col = 'black')
     points(77.86275, 3.0, , pch = 15, cex =3, col = 'grey')
     # EQ VAS
     segments(x0 = 58.73929, y0 = 2.5,  x1 = 69.98458, y1 = 2.5, lwd = 2, col = 'black')
     points(64.36194, 2.5, pch = 15, cex =3, col = 'grey')
text(x = 60, y = 2.10, expression(chi[1]^2 ==253))
text(x = 67, y = 2.10, paste(', p < 0.0001'))
